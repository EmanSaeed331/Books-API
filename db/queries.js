exports.queryList = {
    ...
    GET_BOOK_DETAILS_QUERY:`SELECT BOOK_ID, BOOK_TITLE, BOOK_DESCRIPTION, BOOK_AUTHER, BOOK_PUBLISHER, BOOK_PAGES, STORE_CODE , STORE.STORE_NAME ,STORE.ADDRESS FROM BMS.BOOK
